...
namespace ProjectForLanguage
{
    public partial class FrmAddWord : Form
    {
        ...
        private string connectionString = "Data Source=BEKIR;Initial Catalog=LanguageApp;Integrated Security=True";
        ...
        private void lblUserMail_Click(object sender, EventArgs e)
        {
